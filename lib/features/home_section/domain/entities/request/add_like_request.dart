...
class AddPackageLikeRequest {
    ...
    factory AddPackageLikeRequest.fromJson(Map<String, dynamic> json) => AddPackageLikeRequest(
...
class AddPartnerLikeRequest {
    ...
    factory AddPartnerLikeRequest.fromJson(Map<String, dynamic> json) => AddPartnerLikeRequest(
        userUuid: json["user_uuid"],
