class ChildCategoryEntity {
  ...
  factory ChildCategoryEntity.fromJson(Map<String, dynamic> json) =>
      ChildCategoryEntity(
        code: json["code"],
...
class ChildCategory {
  ...
  Map<String, dynamic> toJson() => {
        ...
        "selected_parent_categories": selectedParentCategories == null
            ? []
            : List<dynamic>.from(selectedParentCategories!.map((x) => x)),
        "updated_on": updatedOn.toIso8601String(),
        "is_active": isActive,
        "parent_category_name": parentCategoryName == null
            ? []
            : List<dynamic>.from(parentCategoryName!.map((x) => x)),
