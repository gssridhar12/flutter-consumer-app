...
abstract class UserRepository {
  ...
  Future<Either<Failure, AddPackageReviewEntity>> addPackageReview({required AddPackageReviewRequest  request});
  Future<Either<Failure, UpdateUserEntity>> updateUserDetails(UpdateUserRequest request);
}
