...
part 'fresh_talent_model.freezed.dart';
part 'fresh_talent_model.g.dart';

@freezed
class FreshTalentModel extends FreshTalentEntity with _$FreshTalentModel {
    const factory FreshTalentModel({
    ...
    factory FreshTalentModel.fromJson(Map<String, dynamic> json) => _$FreshTalentModelFromJson(json);
}
...
class ProfileProfileModel extends ProfileProfile with _$ProfileProfileModel {
    const factory ProfileProfileModel({
        ...
        @JsonKey(name: "partnerLocation") List<PartnerLocationModel>? partnerLocation,
