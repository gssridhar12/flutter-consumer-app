...
class AllProfileModel extends AllProfileEntity  with _$AllProfileModel {
    ...
    factory AllProfileModel.fromJson(Map<String, dynamic> json) => _$AllProfileModelFromJson(json);
}
...
class DataModel extends Data with _$DataModel {
    const factory DataModel({
        ...
        required List<ProfileElementModel> profiles,
        @JsonKey(name: "page")
        required int page,
        @JsonKey(name: "size")
        required int size,
...
class ProfileElementModel extends ProfileElement with _$ProfileElementModel {
    const factory ProfileElementModel({
        ...
        required ProfileProfileModel profile,
    }) = _ProfileElementModel;

    factory ProfileElementModel.fromJson(Map<String, dynamic> json) => _$ProfileElementModelFromJson(json);
}
...
class ProfileProfileModel extends ProfileProfile with _$ProfileProfileModel {
    ...
    factory ProfileProfileModel.fromJson(Map<String, dynamic> json) => _$ProfileProfileModelFromJson(json);
}
...
class MegmoGigModel extends MegmoGig with _$MegmoGigModel {
    const factory MegmoGigModel({
        ...
        required List<String> otherMedia,
    }) = _MegmoGigModel;
...
class PortfolioModel extends Portfolio with _$PortfolioModel {
    const factory PortfolioModel({
        ...
        required String projectHeadline,
...
@freezed
class SubscriptionAgreementModel extends SubscriptionAgreement with _$SubscriptionAgreementModel {
    ...
    factory SubscriptionAgreementModel.fromJson(Map<String, dynamic> json) => _$SubscriptionAgreementModelFromJson(json);
}