...
class _$GetUserModelImpl implements _GetUserModel {
  ...
  @override
  String toString() {
    return 'GetUserModel(code: $code, message: $message, data: $data, successStatus: $successStatus)';
  }
