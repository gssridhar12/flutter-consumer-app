...
part of 'get_package_like_model.dart';
...
GetPackageLikeModel _$GetPackageLikeModelFromJson(Map<String, dynamic> json) {
  return _GetPackageLikeModel.fromJson(json);
}

/// @nodoc
mixin _$GetPackageLikeModel {
  @JsonKey(name: "code")
  ...
  @JsonKey(ignore: true)
  $GetPackageLikeModelCopyWith<GetPackageLikeModel> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $GetPackageLikeModelCopyWith<$Res> {
  factory $GetPackageLikeModelCopyWith(
          GetPackageLikeModel value, $Res Function(GetPackageLikeModel) then) =
      _$GetPackageLikeModelCopyWithImpl<$Res, GetPackageLikeModel>;
  @useResult
  $Res call(
...
/// @nodoc
class _$GetPackageLikeModelCopyWithImpl<$Res, $Val extends GetPackageLikeModel>
    implements $GetPackageLikeModelCopyWith<$Res> {
  _$GetPackageLikeModelCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$GetPackageLikeModelImplCopyWith<$Res>
    implements $GetPackageLikeModelCopyWith<$Res> {
  factory _$$GetPackageLikeModelImplCopyWith(_$GetPackageLikeModelImpl value,
          $Res Function(_$GetPackageLikeModelImpl) then) =
      __$$GetPackageLikeModelImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "code") String? code,
...
/// @nodoc
class __$$GetPackageLikeModelImplCopyWithImpl<$Res>
    extends _$GetPackageLikeModelCopyWithImpl<$Res, _$GetPackageLikeModelImpl>
    implements _$$GetPackageLikeModelImplCopyWith<$Res> {
  __$$GetPackageLikeModelImplCopyWithImpl(_$GetPackageLikeModelImpl _value,
      $Res Function(_$GetPackageLikeModelImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$GetPackageLikeModelImpl(
      code: freezed == code
          ? _value.code
          : code // ignore: cast_nullable_to_non_nullable
              as String?,
...
/// @nodoc
@JsonSerializable()
class _$GetPackageLikeModelImpl implements _GetPackageLikeModel {
  const _$GetPackageLikeModelImpl(
      {@JsonKey(name: "code") this.code,
      @JsonKey(name: "message") this.message,
      @JsonKey(name: "data") this.data,
      @JsonKey(name: "success_status") this.successStatus});

  factory _$GetPackageLikeModelImpl.fromJson(Map<String, dynamic> json) =>
      _$$GetPackageLikeModelImplFromJson(json);
  ...
  @override
  String toString() {
    return 'GetPackageLikeModel(code: $code, message: $message, data: $data, successStatus: $successStatus)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$GetPackageLikeModelImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$GetPackageLikeModelImplCopyWith<_$GetPackageLikeModelImpl> get copyWith =>
      __$$GetPackageLikeModelImplCopyWithImpl<_$GetPackageLikeModelImpl>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$GetPackageLikeModelImplToJson(
      this,
    );
  }
}

abstract class _GetPackageLikeModel implements GetPackageLikeModel {
  const factory _GetPackageLikeModel(
          {@JsonKey(name: "code") final String? code,
          @JsonKey(name: "message") final String? message,
          @JsonKey(name: "data") final DataModel? data,
          @JsonKey(name: "success_status") final bool? successStatus}) =
      _$GetPackageLikeModelImpl;

  factory _GetPackageLikeModel.fromJson(Map<String, dynamic> json) =
      _$GetPackageLikeModelImpl.fromJson;
