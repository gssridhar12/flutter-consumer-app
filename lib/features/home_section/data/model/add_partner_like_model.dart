...
@freezed
class AddPartnerLikeModel extends AddPartnerLikeEntity with _$AddPartnerLikeModel {
    ...
    factory AddPartnerLikeModel.fromJson(Map<String, dynamic> json) => _$AddPartnerLikeModelFromJson(json);
}
