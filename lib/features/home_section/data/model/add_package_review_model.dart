...
AddPackageReviewModel addPackageReviewModelFromJson(String str) => AddPackageReviewModel.fromJson(json.decode(str));

String addPackageReviewModelToJson(AddPackageReviewModel data) => json.encode(data.toJson());

@freezed
class AddPackageReviewModel extends AddPackageReviewEntity with _$AddPackageReviewModel {
    ...
    factory AddPackageReviewModel.fromJson(Map<String, dynamic> json) => _$AddPackageReviewModelFromJson(json);
}
