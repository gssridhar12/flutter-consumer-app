...
@freezed
class SelectedChildCategoryModel extends SelectedChildCategory with _$SelectedChildCategoryModel {
    ...
    factory SelectedChildCategoryModel.fromJson(Map<String, dynamic> json) => _$SelectedChildCategoryModelFromJson(json);
}