...
_$AllProfileModelImpl _$$AllProfileModelImplFromJson(
...
Map<String, dynamic> _$$AllProfileModelImplToJson(
        _$AllProfileModelImpl instance) =>
    <String, dynamic>{
      'code': instance.code,
...
_$ProfileElementModelImpl _$$ProfileElementModelImplFromJson(
    ...
    _$ProfileElementModelImpl(
      subscriptionAgreement: json['subscriptionAgreement'] == null
          ? null
          : SubscriptionAgreementModel.fromJson(
              json['subscriptionAgreement'] as Map<String, dynamic>),
      profile:
          ProfileProfileModel.fromJson(json['profile'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$$ProfileElementModelImplToJson(
        _$ProfileElementModelImpl instance) =>
    <String, dynamic>{
      'subscriptionAgreement': instance.subscriptionAgreement,
...
_$SubscriptionAgreementModelImpl _$$SubscriptionAgreementModelImplFromJson(
        Map<String, dynamic> json) =>
...
Map<String, dynamic> _$$SubscriptionAgreementModelImplToJson(
        _$SubscriptionAgreementModelImpl instance) =>
    <String, dynamic>{
