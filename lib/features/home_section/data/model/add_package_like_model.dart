...
AddPackageLikeModel addPackageLikeModelFromJson(String str) => AddPackageLikeModel.fromJson(json.decode(str));

String addPackageLikeModelToJson(AddPackageLikeModel data) => json.encode(data.toJson());

@freezed
class AddPackageLikeModel extends AddPackageLikeEntity with _$AddPackageLikeModel {
    ...
    factory AddPackageLikeModel.fromJson(Map<String, dynamic> json) => _$AddPackageLikeModelFromJson(json);
}
