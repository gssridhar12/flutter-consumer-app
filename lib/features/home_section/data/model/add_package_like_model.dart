...
//
//     final addPackageLikeModel = addPackageLikeModelFromJson(jsonString);
...
part 'add_package_like_model.freezed.dart';
part 'add_package_like_model.g.dart';

AddPackageLikeModel addPackageLikeModelFromJson(String str) =>
    AddPackageLikeModel.fromJson(json.decode(str));

String addPackageLikeModelToJson(AddPackageLikeModel data) =>
    json.encode(data.toJson());

@freezed
class AddPackageLikeModel extends AddPackageLikeEntity
    with _$AddPackageLikeModel {
  const factory AddPackageLikeModel({
    @JsonKey(name: "code") String? code,
    @JsonKey(name: "message") String? message,
    @JsonKey(name: "data") DataModel? data,
    @JsonKey(name: "success_status") bool? successStatus,
  }) = _AddPackageLikeModel;

  factory AddPackageLikeModel.fromJson(Map<String, dynamic> json) =>
      _$AddPackageLikeModelFromJson(json);
}
...
class LikedPackageModel extends LikedPackage with _$LikedPackageModel {
  ...
  factory LikedPackageModel.fromJson(Map<String, dynamic> json) =>
      _$LikedPackageModelFromJson(json);
}
