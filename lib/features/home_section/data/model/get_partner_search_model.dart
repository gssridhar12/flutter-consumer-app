...
@freezed
class GetPartnerSearchModel extends GetPartnerSearchEntity
    with _$GetPartnerSearchModel {
  ...
  factory GetPartnerSearchModel.fromJson(Map<String, dynamic> json) =>
      _$GetPartnerSearchModelFromJson(json);
}
