...
// import 'package:flutter_consumer_app/features/home_section/src/presentation/pages/become_partner/AgeNext.dart';
// import 'package:flutter_consumer_app/features/home_section/src/presentation/widgets/AppbarWedget.dart';

// class NextFourButtonPage extends StatefulWidget {
//   const NextFourButtonPage({Key? key}) : super(key: key);

//   @override
//   State<NextFourButtonPage> createState() => _RatingHomePageState();
// }

// class _RatingHomePageState extends State<NextFourButtonPage> {
...
//                         child: Text(
//                           'Do you provide In-Premise services of Doorstep services?',
//                           style: TextStyle(
//                             color: colorred,
//                             fontSize: 22,
...
//                             0, Icons.business, 'In-Premise'),
//                       ),
//                       sbox20,
//                       Padding(
//                         padding: const EdgeInsets.only(left: 10, right: 10),
//                         child:
//                             buildContainerWithIcon(1, Icons.person, 'Doorstep'),
//                       ),
//                       sbox20,
//                       Padding(
//                         padding: const EdgeInsets.only(left: 10, right: 10),
//                         child: buildContainerWithIcon(2, Icons.group, 'both'),
//                       ),
//                       sbox20,
//                       sbox20,
//                       sbox20,
...
//                               context,
//                               MaterialPageRoute(
//                                   builder: (contex) => const AgeButtonPage()));
//                         },
//                         child: Container(
//                           width: 162,
//                           height: 47,
