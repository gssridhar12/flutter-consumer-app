...
// import 'package:flutter_consumer_app/features/home_section/src/presentation/pages/become_partner/NextFourForm.dart';
// import 'package:flutter_consumer_app/features/home_section/src/presentation/widgets/AppbarWedget.dart';

// class NextMultyThirdButtonPage extends StatefulWidget {
//   const NextMultyThirdButtonPage({Key? key}) : super(key: key);

//   @override
//   State<NextMultyThirdButtonPage> createState() => _RatingHomePageState();
// }

// class _RatingHomePageState extends State<NextMultyThirdButtonPage> {
...
//                           width: 343,
//                           child: Text(
//                             'Choose the entertainment services provided by your business',
//                             style: TextStyle(
//                               color: colorred,
//                               fontSize: 22,
...
//                       sbox,
//                       const Padding(
//                         padding: EdgeInsets.only(right: 130, left: 10),
//                         child: SizedBox(
//                           width: 334,
//                           child: Text(
...
//                             0, Icons.business, 'Wellness and Spa'),
//                       ),
//                       sbox20,
//                       Padding(
//                         padding: const EdgeInsets.only(left: 10, right: 10),
//                         child: buildContainerWithIcon(
//                             1, Icons.person, 'Entertainment'),
//                       ),
//                       sbox20,
//                       Padding(
//                         padding: const EdgeInsets.only(left: 10, right: 10),
//                         child: buildContainerWithIcon(2, Icons.group, 'Beauty'),
//                       ),
//                       sbox20,
//                       Padding(
//                         padding: const EdgeInsets.only(left: 10, right: 10),
//                         child: buildContainerWithIcon(
//                             3, Icons.business, 'Loreum lpsum'),
//                       ),
//                       sbox20,
//                       Padding(
//                         padding: const EdgeInsets.only(left: 10, right: 10),
//                         child: buildContainerWithIcon(4, Icons.person, 'Other'),
//                       ),
//                       sbox20,
//                       Padding(
//                         padding: const EdgeInsets.only(left: 10, right: 10),
//                         child: buildContainerWithIcon(
//                             5, Icons.group, 'Group of Individuals'),
//                       ),
//                       sbox20,
//                       Padding(
//                         padding: const EdgeInsets.only(left: 10, right: 10),
//                         child: buildContainerWithIcon(
//                             6, Icons.group, 'Group of Person'),
//                       ),
//                       sbox20,
//                       sbox20,
//                       sbox20,
...
//                           context,
//                           MaterialPageRoute(
//                             builder: (context) => const NextFourButtonPage(),
//                           ),
//                         );
//                       },
//                       child: Padding(
