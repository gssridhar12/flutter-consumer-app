...
//   const NextButtonPage({Key? key}) : super(key: key);

//   @override
//   State<NextButtonPage> createState() => _RatingHomePageState();
// }

// class _RatingHomePageState extends State<NextButtonPage> {
...
//           child: Padding(
//             padding: const EdgeInsets.only(left: 20, right: 0, top: 25),
//             child: Column(
//               children: [
//                 sbox,
//                 const Padding(
...
//                 sbox20,
//                 Padding(
//                   padding: const EdgeInsets.only(left: 0, right: 45, top: 390),
//                   child: Row(
//                     children: [
//                       Padding(
