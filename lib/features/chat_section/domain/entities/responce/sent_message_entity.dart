...
SentMessageEntity sentMessageEntityFromJson(String str) =>
    SentMessageEntity.fromJson(json.decode(str));

String sentMessageEntityToJson(SentMessageEntity data) =>
...
class Datum {
  ...
  factory Datum.fromJson(Map<String, dynamic> json) => Datum(
        ...
        clientMessages: json["clientMessages"] == null
            ? null
            : List<ClientMessage>.from(
                json["clientMessages"].map((x) => ClientMessage.fromJson(x))),
  ...
  Map<String, dynamic> toJson() => {
        ...
        "clientMessages": clientMessages == null
            ? null
            : List<dynamic>.from(clientMessages!.map((x) => x.toJson())),
...
class ClientMessage {
  ...
  factory ClientMessage.fromJson(Map<String, dynamic> json) => ClientMessage(
        ...
        chatMessage: json["chatMessage"] == null
            ...
            : List<ChatMessage>.from(
                json["chatMessage"].map((x) => ChatMessage.fromJson(x))),
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "chatMessage": chatMessage == null
            ? null
            : List<dynamic>.from(chatMessage!.map((x) => x.toJson())),
      };
}
