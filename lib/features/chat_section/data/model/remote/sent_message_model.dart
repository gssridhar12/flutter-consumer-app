...
class DatumModel extends Datum with _$DatumModel {
    ...
    factory DatumModel.fromJson(Map<String, dynamic> json) => _$DatumModelFromJson(json);
}
...
class ClientMessageModel extends ClientMessage with _$ClientMessageModel {
    ...
    factory ClientMessageModel.fromJson(Map<String, dynamic> json) => _$ClientMessageModelFromJson(json);
}
