...
class PackageReviewEntity {
    ...
    factory PackageReviewEntity.fromJson(Map<String, dynamic> json) => PackageReviewEntity(
        code: json["code"],
...
class Data {
    ...
    factory Data.fromJson(Map<String, dynamic> json) => Data(
        ...
        page: json["page"],
        size: json["size"],
        packageReviews: List<PackageReview>.from(json["packageReviews"].map((x) => PackageReview.fromJson(x))),
    );
    ...
    Map<String, dynamic> toJson() => {
        ...
        "page": page,
        "size": size,
        "packageReviews": List<dynamic>.from(packageReviews.map((x) => x.toJson())),
    };
}
