...
PartnerReviewModel partnerReviewModelFromJson(String str) =>
    PartnerReviewModel.fromJson(json.decode(str));

String partnerReviewModelToJson(PartnerReviewModel data) =>
