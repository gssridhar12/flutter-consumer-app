...
@freezed
class PackageDetailsModel extends PackageDetailsEntity with _$PackageDetailsModel {
  ...
  factory PackageDetailsModel.fromJson(Map<String, dynamic> json) => _$PackageDetailsModelFromJson(json);
}
...
class DataModel extends Data with _$DataModel {
  const factory DataModel({
    ...
    required List<dynamic>? partnerLocation,
  }) = _DataModel;
...
class PackageDetailsModels extends PackageDetails with _$PackageDetailsModels {
  const factory PackageDetailsModels({
    ...
    required double? extraAllowance,
    ...
    required bool? mostBookedPackages,
    @JsonKey(name: "trending_packages")
    required bool? trendingPackages,
    @JsonKey(name: "best_seller_packages")
    required bool? bestSellerPackages,
    @JsonKey(name: "promoted_packages")
    required bool? promotedPackages,
    @JsonKey(name: "packageGallery")
    required List<PackageGalleryModel>? packageGallery,
    @JsonKey(name: "selected_buckets")
    required List<dynamic>? selectedBuckets,
    @JsonKey(name: "created_on")
    required DateTime? createdOn,
  }) = _PackageDetailsModels;

  factory PackageDetailsModels.fromJson(Map<String, dynamic> json) => _$PackageDetailsModelsFromJson(json);
}
...
class PackageGalleryModel extends PackageGallery with _$PackageGalleryModel {
  const factory PackageGalleryModel({
    ...
    required List<dynamic>? assignedTo,
...
class PackageReviewModel extends PackageReview with _$PackageReviewModel {
  const factory PackageReviewModel({
    ...
    required ReviewDetailsModel? reviewDetails,
    @JsonKey(name: "patron_level")
    required int? patronLevel,
  }) = _PackageReviewModel;

  factory PackageReviewModel.fromJson(Map<String, dynamic> json) => _$PackageReviewModelFromJson(json);
}
...
@freezed
class ServiceLocationModel extends ServiceLocation with _$ServiceLocationModel {
  const factory ServiceLocationModel({
    @JsonKey(name: "address_type")
    required String? addressType,
    @JsonKey(name: "city")
    required String? city,
    
  }) = _ServiceLocationModel;

  factory ServiceLocationModel.fromJson(Map<String, dynamic> json) => _$ServiceLocationModelFromJson(json);
}