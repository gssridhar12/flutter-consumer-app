...
@freezed
class GetUserBookingModel extends GetUserBookingEntity with _$GetUserBookingModel {
    ...
    factory GetUserBookingModel.fromJson(Map<String, dynamic> json) => _$GetUserBookingModelFromJson(json);
}
...
class BookingDetailsModel extends BookingDetails with _$BookingDetailsModel {
    ...
    factory BookingDetailsModel.fromJson(Map<String, dynamic> json) => _$BookingDetailsModelFromJson(json);
}
