...
import 'package:flutter_consumer_app/features/partner_profile/presentation/widgets/package_widgets/profile_package_card.dart';
...
class PackagesTabWidget extends StatefulWidget {
  const PackagesTabWidget(
      {super.key, required this.profile, required this.uuid});
...
class _PackagesTabWidgetState extends State<PackagesTabWidget> {
  ...
  @override
  void initState() {
    context.read<BucketBloc>().add(GetBucket(uuid: widget.uuid));
            ...
            children: [
              ...
              BlocBuilder<BucketBloc, BucketState>(
                builder: (context, state) {
                  ...
                  if (state is GetBucketFailed) {
                    return const Text('something went wrong');
                  }
                  if (state is GetBucketSuccess) {
