...
@freezed
class PartnerPackageModel extends PartnerPackageEntity
    with _$PartnerPackageModel {
  ...
  factory PartnerPackageModel.fromJson(Map<String, dynamic> json) =>
      _$PartnerPackageModelFromJson(json);
}
...
class PackageElementModel extends PackageElement with _$PackageElementModel {
  ...
  factory PackageElementModel.fromJson(Map<String, dynamic> json) =>
      _$PackageElementModelFromJson(json);
}
...
class PackagePackageModel extends PackagePackage with _$PackagePackageModel {
  ...
  factory PackagePackageModel.fromJson(Map<String, dynamic> json) =>
      _$PackagePackageModelFromJson(json);
}
...
class ReviewAverageModel extends ReviewAverage with _$ReviewAverageModel {
  ...
  factory ReviewAverageModel.fromJson(Map<String, dynamic> json) =>
      _$ReviewAverageModelFromJson(json);
}
