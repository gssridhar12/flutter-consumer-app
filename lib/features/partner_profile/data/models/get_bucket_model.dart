...
class GetBucketModel extends GetBucketEntity with _$GetBucketModel {
    ...
    factory GetBucketModel.fromJson(Map<String, dynamic> json) => _$GetBucketModelFromJson(json);
}
...
class BucketModel extends Bucket with _$BucketModel {
    const factory BucketModel({
        ...
        required String? bucketCoverImage,
        @JsonKey(name: "status")
    ...
    factory BucketModel.fromJson(Map<String, dynamic> json) => _$BucketModelFromJson(json);
}
...
class SelectedPackageModel extends SelectedPackage with _$SelectedPackageModel {
    ...
    factory SelectedPackageModel.fromJson(Map<String, dynamic> json) => _$SelectedPackageModelFromJson(json);
}
...
@freezed
class PackageReviewAvgModel extends PackageReviewAvg with _$PackageReviewAvgModel {
    ...
    factory PackageReviewAvgModel.fromJson(Map<String, dynamic> json) => _$PackageReviewAvgModelFromJson(json);
}
