...
_$PartnerProfileModelImpl _$$PartnerProfileModelImplFromJson(
...
Map<String, dynamic> _$$PartnerProfileModelImplToJson(
        _$PartnerProfileModelImpl instance) =>
    <String, dynamic>{
      'code': instance.code,
...
Map<String, dynamic> _$$ReviewAveragesModelImplToJson(
    ...
    <String, dynamic>{
      '_id': instance.id,
      'avgCommunication': instance.avgCommunication,
      'avgServiceDescribed': instance.avgServiceDescribed,
      'avgRecommended': instance.avgRecommended,
